...
import frame.contents.DocPanel;
import frame.contents.PasswordPanel;
import frame.contents.UserPanel;
...
//        JMenuItem downloadItem = new JMenuItem("档案下载"); docMenu.add(downloadItem);
        ...
        welcome.add(new JLabel(" 当前用户： "+ MainFrame.user.getUsername()));
        ...
        userMenu.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                updateCenterPanel(new UserPanel());
            }
        });
            //档案管理
        docMenu.addMouseListener(new MouseAdapter() {
            @Override
            public void mousePressed(MouseEvent e) {
                updateCenterPanel(new DocPanel());
            }
        });
            //个人管理
        passwordItem.addMouseListener(new MouseAdapter() { //修改密码
            @Override
            public void mousePressed(MouseEvent e) {
                updateCenterPanel(new PasswordPanel());
            }
        });
        logoutItem.addMouseListener(new MouseAdapter() { //登出
            @Override
            public void mousePressed(MouseEvent e) {
                MainFrame.setContentPanel(new LoginPanel());//登出退回到登录界面
            }
        });
    }
